import '../one3_screen/widgets/one2_item_widget.dart';
                  ...
                  child: Obx(
                    () => PinCodeTextField(
                      ...
                      pinTheme: PinTheme(
                        ...
                        selectedFillColor: ColorConstant.cyan900,
                        activeFillColor: ColorConstant.cyan900,
                        inactiveFillColor: ColorConstant.cyan900,
              ...
              Padding(
                ...
                child: Obx(
                  () => ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount:
                        controller.one3ModelObj.value.one2ItemList.length,
                    itemBuilder: (context, index) {
                      One2ItemModel model =
                          controller.one3ModelObj.value.one2ItemList[index];
